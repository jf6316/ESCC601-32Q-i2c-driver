...
static SENSOR_DEVICE_ATTR(psu1_good             , S_IRUGO           , psu_status_get           , NULL                     , PSU1_GOOD);
static SENSOR_DEVICE_ATTR(psu2_good             , S_IRUGO           , psu_status_get           , NULL                     , PSU2_GOOD);
static SENSOR_DEVICE_ATTR(psu1_prnt             , S_IRUGO           , psu_present_get          , NULL                     , PSU1_PRNT);
static SENSOR_DEVICE_ATTR(psu2_prnt             , S_IRUGO           , psu_present_get          , NULL                     , PSU2_PRNT);
